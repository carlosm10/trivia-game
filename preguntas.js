const defaultData = [
      ...
      // 6) Direct
      { type: 4, instruction: "Pregunta Directa", pregunta: "¿Cuál debe ser vuestra oración, de acuerdo al capítulo 3: Un poder que convence?", respuesta: "“Crea en mi, oh Dios, un corazón limpio, y renueva la firmeza de mi espíritu” Salmo 51:10" },
      // 7) Direct
      ...
      // 13) Direct
      { type: 1, instruction: "Pregunta Directa", pregunta: "¿Cuáles son las formas en que Dios nos habla según el capitulo 11?", respuesta: "De 4 formas. Por la naturaleza y por la revelación, por su providencia y por la influencia de su Espíritu." },
      // 14) True/False
      ...
      { type: 4, instruction: "Opción Múltiple", pregunta: "¿Nombre del capitulo del Camino a Cristo que menciona la parábola del hijo pródigo? ", opciones: 
        ["A) La fuente de regocijo y felicidad, cap. 13.", "B) El gozo de la colaboración, cap. 9.", "C) Maravillas obradas por la fe, cap. 6.", "D) El secreto del crecimiento, cap. 8."], respuesta: "C) Maravillas obradas por la fe, cap. 6." },
      // 29) Direct
